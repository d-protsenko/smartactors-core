...
public class PluginEmbeddedSensorStrategies extends BootstrapPlugin {
    ...
    public void registerCountStrategy()
        ...
        IOC.register(Keys.resolveByName("embedded sensor count strategy"), new SingletonStrategy(new CountStrategy()));
    }
    ...
    public void registerTimeDeltaStrategy()
            throws ResolutionException, RegistrationException, InvalidArgumentException {
        IFieldName limitFieldName = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "limit");
        ...
        IOC.register(Keys.resolveByName("embedded sensor time delta strategy for limited count"), new ApplyFunctionToArgumentsStrategy(args -> {
