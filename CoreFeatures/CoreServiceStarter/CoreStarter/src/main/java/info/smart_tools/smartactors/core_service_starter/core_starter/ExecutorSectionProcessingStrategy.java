...
public class ExecutorSectionProcessingStrategy implements ISectionStrategy {
    ...
    public ExecutorSectionProcessingStrategy()
        ...
        this.name = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "executor");
        this.threadCountFieldName = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "threadCount");
        this.maxRunningThreadsFieldName = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "maxRunningThreads");
        this.maxExecutionDelayFieldName = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "maxExecutionDelay");
        this.defaultStackDepthFieldName = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "defaultStackDepth");
    }
    ...
    public void onLoadConfig(final IObject config)
        ...
        try {
            ...
            IQueue<ITask> queue = IOC.resolve(Keys.resolveByName(IQueue.class.getCanonicalName()), section);
            ...
            IOC.register(Keys.resolveByName("task_dispatcher"), new SingletonStrategy(taskDispatcher));
            IOC.register(Keys.resolveByName("task_queue"), new SingletonStrategy(queue));
            IOC.register(Keys.resolveByName("thread_pool"), new SingletonStrategy(threadPool));
            IOC.register(
                    Keys.resolveByName("default_stack_depth"),
    ...
    public void onRevertConfig(final IObject config)
        ...
        try {
            IThreadPool threadPool = IOC.resolve(Keys.resolveByName("thread_pool"));
            threadPool.terminate();
