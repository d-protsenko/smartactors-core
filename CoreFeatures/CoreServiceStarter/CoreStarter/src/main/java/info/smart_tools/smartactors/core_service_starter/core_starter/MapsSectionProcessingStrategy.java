...
public class MapsSectionProcessingStrategy implements ISectionStrategy {
    ...
    public MapsSectionProcessingStrategy()
        ...
        this.name = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "maps");
        this.mapIdFieldName = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "id");
    }
    ...
    public void onLoadConfig(final IObject config)
        ...
        try {
            ...
            for (IObject mapDescription : section) {
                Object chainId = IOC.resolve(Keys.resolveByName("chain_id_from_map_name"), mapDescription.getValue(mapIdFieldName));
                try {
