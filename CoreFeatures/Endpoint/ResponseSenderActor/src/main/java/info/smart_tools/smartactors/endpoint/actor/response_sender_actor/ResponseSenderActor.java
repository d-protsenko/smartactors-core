...
public class ResponseSenderActor {
    ...
    public void sendResponse(final ResponseSenderMessage message)
        ...
        try {
            ...
            IObject environment = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.iobject.IObject"));
            ...
            IFieldName configFieldName = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "config");
            IFieldName messageFieldName = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "message");
