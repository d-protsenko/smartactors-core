...
public class ContinuouslyRepeatScheduleStrategyTest extends PluginsLoadingTestBase {
    ...
    protected void registerMocks() throws Exception {
        ...
        start = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "start");
        interval = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "interval");
    }
    ...
    public void Should_reschedulePausedEntry()
        ...
        ISchedulingStrategy strategy = new ContinuouslyRepeatScheduleStrategy();
        when(entry.getState()).thenReturn(
                IOC.resolve(Keys.resolveByName(IObject.class.getCanonicalName()),
                        "{'start':'1994-10-15T17:32:05','interval':'P2M'}".replace('\'','"')));
