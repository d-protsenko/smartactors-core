...
public class DefaultSchedulerAction implements ISchedulerAction {
    ...
    public DefaultSchedulerAction()
        ...
        setEntryIdFieldName = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "setEntryId");
    ...
    public void init(final ISchedulerEntry entry, final IObject args)
        ...
        try {
            ...
            if (entryIdFieldFN != null && !entryIdFieldFN.isEmpty()) {
                ((IObject) message).setValue(IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), entryIdFieldFN), entry.getId());
            }
    ...
    public void execute(final ISchedulerEntry entry)
        ...
        try {
            ...
            message = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.iobject.IObject"), serialized);
