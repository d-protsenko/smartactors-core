...
public class DatabaseRemoteStorage implements IRemoteEntryStorage {
    ...
    public DatabaseRemoteStorage(final IPool connectionPool, final String collectionName)
        ...
        filterFieldName = IOC.resolve(Keys.resolveByName(IFieldName.class.getCanonicalName()), "filter");
        gtFieldName = IOC.resolve(Keys.resolveByName(IFieldName.class.getCanonicalName()), "$gt");
        ltFieldName = IOC.resolve(Keys.resolveByName(IFieldName.class.getCanonicalName()), "$lt");
        eqFieldName = IOC.resolve(Keys.resolveByName(IFieldName.class.getCanonicalName()), "$eq");
        entryIdFieldName = IOC.resolve(Keys.resolveByName(IFieldName.class.getCanonicalName()), "entryId");
        pageFieldName = IOC.resolve(Keys.resolveByName(IFieldName.class.getCanonicalName()), "page");
        sizeFieldName = IOC.resolve(Keys.resolveByName(IFieldName.class.getCanonicalName()), "size");
        documentIdFieldName = IOC.resolve(Keys.resolveByName(IFieldName.class.getCanonicalName()), collectionName.toLowerCase() + "ID");
        lastScheduledTimeFieldName = IOC.resolve(Keys.resolveByName(IFieldName.class.getCanonicalName()), LAST_SCHEDULED_TIME_FIELD_NAME);

        entriesQuery = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.iobject.IObject"),
                String.format(("{" +
    ...
    public IObject querySingleEntry(final String id) throws EntryStorageAccessException, EntryNotFoundException {
        try (IPoolGuard guard = new PoolGuard(connectionPool)) {
            ...
            IObject query = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.iobject.IObject"));
            IObject filter = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.iobject.IObject"));
            IObject entryIdFilter = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.iobject.IObject"));
