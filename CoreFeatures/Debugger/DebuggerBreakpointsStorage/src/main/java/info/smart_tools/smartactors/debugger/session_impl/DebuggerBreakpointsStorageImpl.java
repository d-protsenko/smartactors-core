...
public class DebuggerBreakpointsStorageImpl implements IDebuggerBreakpointsStorage {
    ...
    private final class Breakpoint {
        ...
        private Breakpoint(final Object chainName, final int stepId, final String id, final boolean enabled, final IObject args)
            ...
            this.asIObject = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.iobject.IObject"));
    ...
    public DebuggerBreakpointsStorageImpl()
        ...
        chainFN = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "chain");
        stepFN = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "step");
        enabledFN = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "enabled");
        idFN = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "id");
