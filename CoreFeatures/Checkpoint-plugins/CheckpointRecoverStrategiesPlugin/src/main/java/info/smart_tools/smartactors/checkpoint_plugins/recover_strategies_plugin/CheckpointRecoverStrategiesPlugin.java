...
public class CheckpointRecoverStrategiesPlugin extends BootstrapPlugin {
    ...
    public void singleChainRecoverStrategyItem()
        ...
        IOC.register(Keys.resolveByName("single chain recover strategy"),
    ...
    public void chainSequenceRecoverStrategy()
            throws ResolutionException, RegistrationException, InvalidArgumentException {
        IOC.register(Keys.resolveByName("chain sequence recover strategy"),
    ...
    public void sequenceRecoverStrategy()
            throws ResolutionException, RegistrationException, InvalidArgumentException {
        IOC.register(Keys.resolveByName("restore sequence recover strategy"),
