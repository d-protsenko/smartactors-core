 ...
 */
public class ShortArrayToListResolutionStrategy implements IResolutionStrategy {
    ...
    public <T> T resolve(final Object... args) throws ResolutionStrategyException {
        try {
            ...
            throw new ResolutionStrategyException("Can't create list from short array.", e);
        }
    }
}
