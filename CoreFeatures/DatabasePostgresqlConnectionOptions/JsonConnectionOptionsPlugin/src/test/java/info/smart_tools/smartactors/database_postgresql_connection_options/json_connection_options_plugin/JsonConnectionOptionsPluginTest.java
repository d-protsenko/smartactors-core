...
public class JsonConnectionOptionsPluginTest {
    @Before
    public void init() throws Exception {
        ...
        new JsonConnectionOptionsPlugin(bootstrap).load();
        bootstrap.start();
    }

    @Test
    public void Should_registerActor() throws ResolutionException {
        assertTrue(IOC.resolve(Keys.getOrAdd("PostgresJsonConnectionOptionsActor"))
                instanceof JsonConnectionOptionsActor);
    }
}
