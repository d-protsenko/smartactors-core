...
public class ActorReceiver implements IMessageReceiver {
    ...
    public ActorReceiver(final IMessageReceiver childReceiver)
        ...
        this.queue = IOC.resolve(IOC.resolve(IOC.getKeyForKeyByNameResolveStrategy(), "actor_receiver_queue"));
        this.isBusy = IOC.resolve(IOC.resolve(IOC.getKeyForKeyByNameResolveStrategy(), "actor_receiver_busyness_flag"));
    }
