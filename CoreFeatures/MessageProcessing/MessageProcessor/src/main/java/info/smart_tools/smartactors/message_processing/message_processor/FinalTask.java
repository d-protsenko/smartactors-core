...
public class FinalTask implements ITask {
    ...
    public FinalTask(final IObject environment)
        ...
        finalActionsFieldName = IOC.resolve(IOC.resolve(IOC.getKeyForKeyByNameResolveStrategy(), "info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "finalActions");
    }
