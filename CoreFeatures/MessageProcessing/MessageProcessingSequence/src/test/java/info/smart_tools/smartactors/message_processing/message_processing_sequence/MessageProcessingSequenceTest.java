...
//        when(secondaryChain.getExceptionalChainNamesAndEnvironments(same(exception))).thenReturn(mock(IObject.class));
    ...
    public void Should_createDumpOfItsState()
        ...
        */
        ...
        Collection srs = (Collection) dump.getValue(IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "scopeRestorationsStack"));
