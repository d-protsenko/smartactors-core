...
public final class InMemoryDatabaseIOCInitializer {
    ...
    private static void registerNextIdStrategy() throws ResolutionException, RegistrationException {
        IOC.register(Keys.resolveByName("db.collection.nextid"), new UuidNextIdStrategy());
    }
    ...
    private static void registerCompareSimpleObjects() throws RegistrationException, ResolutionException, InvalidArgumentException {
        IOC.register(Keys.resolveByName("CompareSimpleObjects"), new ApplyFunctionToArgumentsStrategy(
                        (args) -> {
                            Object entry = args[0];
    ...
    private static void registerNestedFieldName() throws RegistrationException, ResolutionException, InvalidArgumentException {
        IOC.register(Keys.resolveByName("NestedFieldName"), new ApplyFunctionToArgumentsStrategy(
                        (args) -> {
    ...
    private static void initGeneralResolver(final Map<String, IConditionVerifier> verifierMap) {
        verifierMap.put("$general_resolver", (condition, document) -> {
                    ...
                    while (mainIterator.hasNext()) {
                        ...
                        try {
                            IObject iObject = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.iobject.IObject"));
                    ...
                    if (and.size() > 1) {
                        ...
                        try {
                            newCondition = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.iobject.IObject"));
                            andFieldName = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "$and");
    ...
    private static void initEqOperations(final Map<String, IConditionVerifier> verifierMap) {
        verifierMap.put("$eq", (condition, document) -> {
                    ...
                    try {
                        Object entry = IOC.resolve(Keys.resolveByName("NestedFieldName"), fieldName, document);
        ...
        verifierMap.put("$gt", (condition, document) -> {
                    ...
                    try {
                        ...
                        return ((Integer) IOC.resolve(
                                Keys.resolveByName("CompareSimpleObjects"), entry, reference)
                        ) > 0;
                    } catch (ReadValueException | InvalidArgumentException | ResolutionException e) {
                    }
                    return false;
        ...
        verifierMap.put("$lte", (condition, document) -> {
                    ...
                    try {
                        Object entry = IOC.resolve(
                                Keys.resolveByName("NestedFieldName"),
                                fieldName,
                                document
                        );
                        Object reference = ((IObject) condition.getValue(fieldName))
    ...
    private static void registerVerifierMapCalls(final Map<String, IConditionVerifier> verifierMap)
        ...
        IOC.register(
                Keys.resolveByName("ResolveDataBaseCondition"),
        ...
        IOC.register(Keys.resolveByName("ContainsResolveDataBaseCondition"),
                new ApplyFunctionToArgumentsStrategy(
                        (args) ->
    ...
    private static void registerPagingForDatabaseCollection() throws RegistrationException, ResolutionException, InvalidArgumentException {
        IOC.register(Keys.resolveByName("PagingForDatabaseCollection"),
                new ApplyFunctionToArgumentsStrategy(
                        (args) -> {
    ...
    private static void registerSortIObjects() throws RegistrationException, ResolutionException, InvalidArgumentException {
        IOC.register(Keys.resolveByName("SortIObjects"), new ApplyFunctionToArgumentsStrategy(
                        (args) -> {
                            ...
                            try {
                                ...
                                IFieldName sortFieldName = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "sort");
                            ...
                            Comparator comparator = (o1, o2) -> {
                                try {
                                    ...
                                    for (int i = 0; i < sortingFields.size(); i++) {
                                        Object object1 = IOC.resolve(Keys.resolveByName("NestedFieldName"), sortingFields.get(i), o1);
                                        Object object2 = IOC.resolve(Keys.resolveByName("NestedFieldName"), sortingFields.get(i), o2);
                                        compare = IOC.resolve(Keys.resolveByName("CompareSimpleObjects"), object1, object2);
                                        if (compare != 0) {
    ...
    private static void registerDataBaseItem() throws RegistrationException, ResolutionException, InvalidArgumentException {
        IOC.register(Keys.resolveByName(DataBaseItem.class.getCanonicalName()), new CreateNewInstanceStrategy(
                        (args) -> {
                            try {
    ...
    private static void registerInMemoryDatabase()
        ...
        IOC.register(
                Keys.resolveByName(InMemoryDatabase.class.getCanonicalName()),
