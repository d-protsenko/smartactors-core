...
public class CookiesSetter implements ICookiesSetter {
    ...
    public void set(final Object response, final IObject environment) throws CookieSettingException {
        ...
        try {
            ...
            cookiesField = IOC.resolve(Keys.getKeyByName(IField.class.getCanonicalName()), "cookies");
            cookieName = IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "name");
            cookieValue = IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "value");
            cookiePath = IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "path");
            maxAgeFieldName = IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "maxAge");
