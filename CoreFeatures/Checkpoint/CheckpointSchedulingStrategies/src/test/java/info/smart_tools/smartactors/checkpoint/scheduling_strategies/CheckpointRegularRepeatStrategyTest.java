...
public class CheckpointRegularRepeatStrategyTest extends PluginsLoadingTestBase {
    ...
    private void makeEntry(final String stateSrc) throws Exception {
        ...
        entryState = IOC.resolve(Keys.getOrAdd(IObject.class.getCanonicalName()), stateSrc.replace('\'','"'));
        when(entryMock.getState()).thenReturn(entryState);
    }

    private IObject makeArgs(final String src) throws Exception {
        return IOC.resolve(Keys.getOrAdd(IObject.class.getCanonicalName()), src.replace('\'','"'));
    }
    ...
    public void Should_copyArgumentsToEntryState()
        ...
        assertEquals("PT3H", entryState.getValue(IOC.resolve(Keys.getOrAdd(IFieldName.class.getCanonicalName()), "interval")));
        assertEquals("PT3H", entryState.getValue(IOC.resolve(Keys.getOrAdd(IFieldName.class.getCanonicalName()), "postRestoreDelay")));
        assertEquals("PT3H", entryState.getValue(IOC.resolve(Keys.getOrAdd(IFieldName.class.getCanonicalName()), "postCompletionDelay")));
        assertEquals(2, entryState.getValue(IOC.resolve(Keys.getOrAdd(IFieldName.class.getCanonicalName()), "times")));
        assertEquals(1, entryState.getValue(IOC.resolve(Keys.getOrAdd(IFieldName.class.getCanonicalName()), "remainingTimes")));
        ...
        assertEquals("PT2H", entryState.getValue(IOC.resolve(Keys.getOrAdd(IFieldName.class.getCanonicalName()), "interval")));
        assertEquals("PT3H", entryState.getValue(IOC.resolve(Keys.getOrAdd(IFieldName.class.getCanonicalName()), "postRestoreDelay")));
        assertEquals("PT4H", entryState.getValue(IOC.resolve(Keys.getOrAdd(IFieldName.class.getCanonicalName()), "postCompletionDelay")));
        assertEquals(3, entryState.getValue(IOC.resolve(Keys.getOrAdd(IFieldName.class.getCanonicalName()), "times")));
        assertEquals(2, entryState.getValue(IOC.resolve(Keys.getOrAdd(IFieldName.class.getCanonicalName()), "remainingTimes")));
    }
    ...
    public void Should_rescheduleEntryInIntervalWhenThereAreTrialsRemainingAndTheEntryIsNotCompleted()
        ...
        assertNull(entryState.getValue(IOC.resolve(Keys.getOrAdd(IFieldName.class.getCanonicalName()), "completed")));
    }
    ...
    public void Should_applyPostCompletionDelayWhenRestoresCompletedEntry()
        ...
        assertEquals(0, entryState.getValue(IOC.resolve(Keys.getOrAdd(IFieldName.class.getCanonicalName()), "remainingTimes")));
    }
