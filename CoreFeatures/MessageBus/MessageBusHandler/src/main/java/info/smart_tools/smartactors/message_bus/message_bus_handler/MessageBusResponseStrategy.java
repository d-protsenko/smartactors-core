...
public class MessageBusResponseStrategy implements IResponseStrategy {
    ...
    public MessageBusResponseStrategy()
        ...
        replyChainFieldName = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "messageBusReplyTo");
        responseStrategyFieldName = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "responseStrategy");

        nullResponseStrategy = IOC.resolve(Keys.resolveByName("null response strategy"));
    }
    ...
    public void sendResponse(IObject environment) throws ResponseException {
        try {
            ...
            response = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.iobject.IObject"), sResponse);
