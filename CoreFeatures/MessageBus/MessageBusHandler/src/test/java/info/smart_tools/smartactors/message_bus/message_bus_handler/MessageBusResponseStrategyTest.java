...
public class MessageBusResponseStrategyTest extends PluginsLoadingTestBase {
    ...
    protected void registerMocks() throws Exception {
        ...
        IOC.register(Keys.resolveByName("null response strategy"), new SingletonStrategy(nullResponseStrategyMock));
        ...
        response = IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.iobject.IObject"), "{\"itIsAResponse\":true}");
        ...
        environment.setValue(IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "response"), response);

        strategy = new MessageBusResponseStrategy();

        context.setValue(IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "responseStrategy"), strategy);
        context.setValue(IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "messageBusReplyTo"), replyChainId);
    }
    ...
    public void Should_sendResponseAndSetResponseStrategyToNullImplementation()
        ...
        assertSame(
                ...
                context.getValue(IOC.resolve(Keys.resolveByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "responseStrategy")));
    }
