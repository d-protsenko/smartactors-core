...
/**
 * Tests for {@link PluginChainTestingAssertions}
 */
public class PluginChainTestingAssertionsTest {
    ...
    public void checkPluginCreation()
        ...
        IPlugin plugin = new PluginChainTestingAssertions(bootstrap);
    ...
    public void checkInvalidArgumentExceptionOnCreation()
            throws Exception {
        new PluginChainTestingAssertions(null);
        fail();
    }
