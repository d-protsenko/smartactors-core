...
/**
 * Function that extracts a inbound Netty reference counted message from message context.
 *
 * @param <TContext> concrete context type
 */
public class InboundMessageExtractor<TContext extends IDefaultMessageContext<? extends ReferenceCounted, ?, ?>>
