 ...
 */
public class PostgresAddFulltextTask implements IDatabaseTask {
     ...
     */
    public PostgresAddFulltextTask(final IStorageConnection connection) {
    ...
    public void prepare(final IObject query) throws TaskPrepareException {
        try {
            ...
            PostgresSchema.addFulltext(preparedQuery, collection, options);
        } catch (Exception e) {
