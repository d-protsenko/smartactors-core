...
public class WDSObjectTest extends IOCInitializer {
    ...
    public void checkIObjectWrapperInterfaceMethods()
        ...
        IObject result = ((IObjectWrapper)wObj).getEnvironmentIObject(FieldNames.getFieldNameByName("message"));
    ...
    public void checkGetEnvironmentIObjectMehtodExceptionOnWrongArgument()
            throws Exception {
        IObject wObj = new WDSObject((IObject) null);
        ((IObjectWrapper)wObj).getEnvironmentIObject(FieldNames.getFieldNameByName("message"));
        fail();
    }
    ...
    public void checkExceptionOnUseDeleteMethod()
            throws Exception {
        IObject wObj = new WDSObject((IObject) null);
        wObj.deleteField(FieldNames.getFieldNameByName("field"));
        fail();
    }
    ...
    public void checkGetValueMethodOnWrongArgument()
            throws Exception {
        IObject wObj = new WDSObject((IObject) null);
        wObj.getValue(FieldNames.getFieldNameByName("undefinedFieldName"));
        fail();
    }
    ...
    public void checkSetValueMethodOnWrongArgument()
            throws Exception {
        IObject wObj = new WDSObject((IObject) null);
        wObj.setValue(FieldNames.getFieldNameByName("undefinedFieldName"), 1);
        fail();
    }
    ...
    public void checkGetValueMethod()
        ...
        when(config.getValue(FieldNames.getFieldNameByName("StringValue"))).thenReturn(rulesList);
        IObject env = mock(IObject.class);
        IObject message = mock(IObject.class);
        ...
        when(submessage.getValue(FieldNames.getFieldNameByName("stringValue"))).thenReturn("1");
        when(rule.getValue(FieldNames.getFieldNameByName("name"))).thenReturn("wds_getter_strategy");
        when(rule.getValue(FieldNames.getFieldNameByName("args"))).thenReturn(new ArrayList<String>(){{add("message/submessage/stringValue");}});
        IObject wObj = new WDSObject(config);
        ((IObjectWrapper) wObj).init(env);
        String i = (String) wObj.getValue(FieldNames.getFieldNameByName("StringValue"));
        assertEquals(i, "1");
    }
    ...
    public void checkSetValueMethod()
        ...
        when(config.getValue(FieldNames.getFieldNameByName("TransformAndSetValue"))).thenReturn(rules);
        IObject env = mock(IObject.class);
        IObject response = mock(IObject.class);
        IObject message = mock(IObject.class);
        when(env.getValue(FieldNames.getFieldNameByName("response"))).thenReturn(response);
        when(env.getValue(FieldNames.getFieldNameByName("message"))).thenReturn(message);
        when(message.getValue(FieldNames.getFieldNameByName("stringValue"))).thenReturn("1");
        when(rule11.getValue(FieldNames.getFieldNameByName("name"))).thenReturn("wds_target_strategy");
        when(rule11.getValue(FieldNames.getFieldNameByName("args"))).thenReturn(new ArrayList<String>(){{add("local/value"); add("response/stringValue");}});
        when(rule21.getValue(FieldNames.getFieldNameByName("name"))).thenReturn("TransformToInt");
        when(rule21.getValue(FieldNames.getFieldNameByName("args"))).thenReturn(new ArrayList<String>(){{add("const/2"); add("message/stringValue");}});
        when(rule22.getValue(FieldNames.getFieldNameByName("name"))).thenReturn("wds_target_strategy");
        when(rule22.getValue(FieldNames.getFieldNameByName("args"))).thenReturn(new ArrayList<String>(){{add("local/value"); add("response/intValue");}});
        doNothing().when(response).setValue(FieldNames.getFieldNameByName("stringValue"), "1");
        doNothing().when(response).setValue(FieldNames.getFieldNameByName("intValue"), 1);
        IObject wObj = new WDSObject(config);
        ((IObjectWrapper) wObj).init(env);
        wObj.setValue(FieldNames.getFieldNameByName("TransformAndSetValue"), "1");
        verify(response, times(1)).setValue(FieldNames.getFieldNameByName("stringValue"), "1");
        verify(response, times(1)).setValue(FieldNames.getFieldNameByName("intValue"), 21);
    }
}
