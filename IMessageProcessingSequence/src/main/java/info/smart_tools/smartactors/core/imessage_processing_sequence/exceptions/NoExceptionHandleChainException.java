 ...
 * info.smart_tools.smartactors.core.imessage_processing_sequence.IMessageProcessingSequence#catchException(Throwable)}
 * when no one of {@link info.smart_tools.smartactors.core.ireceiver_chain.IReceiverChain}'s in the stack defines an
