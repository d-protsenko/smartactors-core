        ...
        try {
            ...
            item
                ...
                try {
                    ...
                    throw new ActionExecuteException("CompileQuery plugin can't load: can't get create strategy", e);
                } catch (RegistrationException e) {
                    throw new ActionExecuteException("CompileQuery plugin can't load: can't get register new strategy", e);
                }
            });
            bootstrap.add(item);
        } catch (InvalidArgumentException e) {
