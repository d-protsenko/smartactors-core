package info.smart_tools.smartactors.test.iassertion.exception;

/**
 * Exception for error in {@link info.smart_tools.smartactors.test.iassertion.IAssertion} method
 */
