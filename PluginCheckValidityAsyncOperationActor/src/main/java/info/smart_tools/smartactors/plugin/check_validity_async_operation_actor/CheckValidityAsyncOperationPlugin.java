        ...
        try {
            ...
            item.process(() -> {
                try {
                    ...
                    throw new ActionExecuteException("CheckValidityAsyncOperationActor plugin can't load: can't get create strategy", e);
                } catch (RegistrationException e) {
                    throw new ActionExecuteException("CheckValidityAsyncOperationActor plugin can't load: can't get register new strategy", e);
                }
            });
            bootstrap.add(item);
        } catch (InvalidArgumentException e) {
