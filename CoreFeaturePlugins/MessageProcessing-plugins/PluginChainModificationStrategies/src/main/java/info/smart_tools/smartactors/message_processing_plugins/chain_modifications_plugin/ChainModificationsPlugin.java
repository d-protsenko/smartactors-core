package info.smart_tools.smartactors.message_processing_plugins.chain_modifications_plugin;
 ...
 *
 */
public class ChainModificationsPlugin extends BootstrapPlugin {
    /**
     * The constructor.
     *
     * @param bootstrap the bootstrap
     */
    public ChainModificationsPlugin(final IBootstrap bootstrap) {
        super(bootstrap);
    }
