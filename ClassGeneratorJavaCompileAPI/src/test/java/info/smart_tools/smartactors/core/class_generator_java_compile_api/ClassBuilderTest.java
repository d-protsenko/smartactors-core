...
public class ClassBuilderTest {
    ...
    public void checkClassBuilder() {
        ...
        cb
                ...
                .addImport("info.smart_tools.smartactors.core.class_generator_java_compile_api.class_builder.ClassBuilder")
                .addImport("info.smart_tools.smartactors.core.class_generator_java_compile_api.class_builder.Modifiers")
        .addClass()
                .setClassName("A")
                .setInherited("B")
                .setInterfaces("IB")
