            ...
            item
                    ...
                    .process(() -> {
                        try {
                            ...
                            throw new ActionExecuteException("GetCookieFromRequestRule plugin can't load: can't get create strategy", e);
                        } catch (RegistrationException e) {
                            throw new ActionExecuteException("GetCookieFromRequestRule plugin can't load: can't get register new strategy", e);
                        }
                    });
            bootstrap.add(item);
        } catch (InvalidArgumentException e) {
