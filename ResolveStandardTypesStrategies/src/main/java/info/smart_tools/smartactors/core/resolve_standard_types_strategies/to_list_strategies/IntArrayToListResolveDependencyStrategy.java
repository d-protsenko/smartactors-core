 ...
 */
public class IntArrayToListResolveDependencyStrategy implements IResolveDependencyStrategy {
    ...
    public <T> T resolve(final Object... args) throws ResolveDependencyStrategyException {
        ...
        try {
            ...
            throw new ResolveDependencyStrategyException("Can't create list from int array.", e);
        }
    }
}
