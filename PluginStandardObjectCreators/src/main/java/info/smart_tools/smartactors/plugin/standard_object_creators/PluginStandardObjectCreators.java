            ...
            creatorsItem
                    ...
                    .process(() -> {
                        try {
                            ...
                            throw new ActionExecuteException("StandardObjectCreators plugin can't load: can't get create strategy", e);
                        } catch (RegistrationException e) {
                            throw new ActionExecuteException("StandardObjectCreators plugin can't load: can't get register new strategy", e);
                        }
                    });
