...
public class MessageProcessingTest {
    ...
    public void test_messageProcessingPerformance()
        ...
        IMessageReceiver countReceiver = (message, onEnd) -> {
        ...
        IMessageReceiver dummyReceiver = (message, onEnd) -> {
            try {
                onEnd.execute(null);
            } catch (ActionExecuteException | InvalidArgumentException e) {
                throw new MessageReceiveException(e);
        ...
        IMessageReceiver countStartReceiver = (message, onEnd) -> {
        ...
        IMessageReceiver countEndReceiver = (message, onEnd) -> {
