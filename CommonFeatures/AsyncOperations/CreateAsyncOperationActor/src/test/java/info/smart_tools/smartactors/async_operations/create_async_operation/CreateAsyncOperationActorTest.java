...
public class CreateAsyncOperationActorTest {
    ...
    public void ShouldCreateOperationAndSetToken()
        ...
        when(IOC.resolve(Keys.resolveByName("db.collection.nextid"))).thenReturn("");
        ...
        when(Keys.resolveByName("info.smart_tools.smartactors.iobject.iobject.IObject")).thenReturn(dataKey);
