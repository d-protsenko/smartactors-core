...
public class CreateCollectionActor {
    public void createTable(CreateCollectionWrapper message) throws CreateCollectionActorException {
        try {
            final ConnectionOptions options = IOC.resolve(Keys.resolveByName(message.getConnectionOptionsRegistrationName()));
            final IPool pool = IOC.resolve(Keys.resolveByName("PostgresConnectionPool"), options);
