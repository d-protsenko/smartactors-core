...
public class PluginInMemoryDatabase implements IPlugin {
    ...
    private void registerCompareSimpleObjects() throws RegistrationException, ResolutionException, InvalidArgumentException {
    ...
    private void registerNestedFieldName() throws RegistrationException, ResolutionException, InvalidArgumentException {
    ...
    private void initVerifierMap(final Map<String, IConditionVerifier> verifierMap) {
    ...
    private void initGeneralResolver(final Map<String, IConditionVerifier> verifierMap) {
    ...
    private void initEqOperations(final Map<String, IConditionVerifier> verifierMap) {
    ...
    private void initGtLtOperations(final Map<String, IConditionVerifier> verifierMap) {
    ...
    private void initDateOperations(final Map<String, IConditionVerifier> verifierMap) {
    ...
    private void initInOperation(final Map<String, IConditionVerifier> verifierMap) {
    ...
    private void initIsNullOperation(final Map<String, IConditionVerifier> verifierMap) {
    ...
    private void initHasTagOperation(final Map<String, IConditionVerifier> verifierMap) {
    ...
    private void initConditions(final Map<String, IConditionVerifier> verifierMap) {
    ...
    private void registerVerifierMapCalls(final Map<String, IConditionVerifier> verifierMap)
    ...
    private void registerPagingForDatabaseCollection() throws RegistrationException, ResolutionException, InvalidArgumentException {
    ...
    private void registerSortIObjects() throws RegistrationException, ResolutionException, InvalidArgumentException {
    ...
    private void registerDataBaseItem() throws RegistrationException, ResolutionException, InvalidArgumentException {
    ...
    private void registerInMemoryDatabase()
