            ...
            chainsStorageItem
                    ...
                    .process(() -> {
                        try {
                            ...
                            throw new ActionExecuteException("ReceiverChainsStorage plugin can't load: can't get create strategy", e);
                        } catch (RegistrationException e) {
                            throw new ActionExecuteException("ReceiverChainsStorage plugin can't load: can't get register new strategy", e);
                        }
                    });
